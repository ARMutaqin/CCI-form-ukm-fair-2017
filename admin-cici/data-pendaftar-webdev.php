...
<body style="background-color: #edf1ec;">	
		 ...
		 <!-- Konten utama -->
			<div class="konten-utama">
			   ...
			   <div class="isi-konten-dashboard" style="margin-left: 70px;">
			   	  <h3 style="margin-bottom: 15px;">Data Pendaftar Web Development</h3>
			   	  	   <!-- Awal Tabel -->
  ...
  <!-- awal data pendaftar dari database -->
          ...
          <?php 
            ...
            $sqlQuery = mysqli_query($connect, "SELECT * FROM pendaftar WHERE divisi='Webdev' ORDER BY id_pendaftar ASC"  );
                    $no = 1;
